    ...
    E.column (mainColumnStyle model)
        [ E.column [ E.spacing 12, E.width (E.px <| appWidth_ model), E.height (E.px (appHeight_ model)) ]
            ...
            , E.column [ E.spacing 12 ]
                [ E.column [ E.spacing 12 ]
                    [ View.Input.editDiaryEntry model (appWidth_ model) model.snippetText
                    , controlAndFilterBar model 
                    , viewDiary model
                    ]
                ]
            , footer model
...
viewDiary : Model -> Element FrontendMsg
viewDiary model =
    E.column
        [ E.spacing 12
        , E.paddingXY 0 0
...
viewDiaryEntry : Model -> Datum -> Element FrontendMsg
viewDiaryEntry model datum =
    let
        predicate =
        ...
        dateString = "**" ++ DateTimeUtility.weekDay model.zone  datum.creationData ++ ", " ++ DateTimeUtility.zonedDateString model.zone datum.creationData ++ "**"
    in
    E.row
        [ Font.size 14
        , E.spacing 12
        ...
        , E.column
            ...
            [ Markdown.Render.toHtml Markdown.Option.ExtendedMath (dateString ++ ": " ++ datum.content)
